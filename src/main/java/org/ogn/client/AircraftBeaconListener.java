...
public interface AircraftBeaconListener {
	 ...
	 *            aircraft beacon
	 * @param descriptor
	 *            static aircraft descriptor. If an aircraft is not recognized
	 *            by the system the <code>isKnown()</code> descriptor's method
	 *            will return false. It is up to the implementing class to
	 *            verify if descriptor is "known", as in case of unknown
	 *            descriptor its attributes are lilely to be null.
	 * @param rawBeacon
